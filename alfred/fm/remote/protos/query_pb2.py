...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _INFERENCERESPONSE._serialized_start = 299
    _INFERENCERESPONSE._serialized_end = 398
    _QUERYSERVICE._serialized_start = 401
    _QUERYSERVICE._serialized_end = 617
